...
class DatabaseHelper {
  ...
  static Future<void> insertDemoPackages() async {
    ...
    try {
      ...
      debugPrint("বর্ধিত ডেমো প্যাকেজগুলো সফলভাবে ইনসার্ট হয়েছে।");
    } catch (e) {
  ...
  Future<void> insertAddons() async {
    final List<Map<String, dynamic>> dummyAddons = [
      ...
      // --- COMMON / BOTH (আপনি চাইলে এগুলোকে 'Common' রাখতে পারেন অথবা দুবার দিতে পারেন) ---
      {
        ...
        "price": 3500,
        "category": "Wedding", // ওয়েডিং এর জন্য
        "iamge_url":
    ...
    try {
      ...
      print("${dummyAddons.length} টি অ্যাড-অন সফলভাবে ইনসার্ট করা হয়েছে!");
    } catch (e) {
  ...
  // ====================================================================================
  // 🔥 🔴 নতুন গ্লোবাল ফাংশন: ফায়ারবেস আইডি দিয়ে সুপাবেস থেকে কাস্টম NSR ID তুলে আনার জন্য
  // ====================================================================================
