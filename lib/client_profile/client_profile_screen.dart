...
class ClientProfileScreen extends StatefulWidget {
  ...
  const ClientProfileScreen({
    super.key,
    this.primaryAccent, // required নেই
    this.selectedIndex,
...
class _ClientProfileScreenState extends State<ClientProfileScreen> {
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ...
                        _buildSingleMenu(
                          ...
                          surface: surface,
                          tealColor: tealColor,
                          onTap: () => print("Settings Screen-এ যাও"),
                        ),
  ...
  Widget _buildHeader(Color gold, Color teal, bool isDark) {
    return Column(
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          "Joined: ${DateFormat('MMM d, yyyy').format(_joinedDate)}",
  ...
  Widget _buildSingleMenu({
    ...
    return SizedBox(
      // ওয়েবে অর্ধেক জায়গা নিবে, মোবাইলে ফুল
      width: isWeb
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          onTap: onTap, // সরাসরি আপনার কাস্টম লজিক এখানে কাজ করবে
        ),
      ),
    );
  }
