...
class CancelledBookingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /// payment and refund amount logic
    ...
    try {
      if (booking['cancelled_at'] != null) {
        ...
        upperBadgeText = diff.inDays > 0
            ? "${diff.inDays} Days Ago"
            : (diff.inHours > 0 ? "${diff.inHours} Hours Ago" : "Just Now");
      }
    } catch (_) {}

    /// chip logic
    String chipLabel = (bookingStatus == "cancellation approved")
        ? "Cancellation APPROVED"
        : "Cancellation PENDING";
    Color chipColor = (chipLabel == "APPROVED" ? Colors.blue : Colors.orange);

    /// timeline logic
    int currentStep = (refundStatus == "refunded")
        ? 3
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    "Booking Payment: $paymentAmount BDT | Refundable Payment: $amountStr ",
